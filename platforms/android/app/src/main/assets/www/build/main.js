...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__ionic_native_transfer__ = __webpack_require__(196);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__ionic_native_file_path__ = __webpack_require__(197);
...
var HomePage = (function () {
    ...
    HomePage.prototype.takePicture = function (sourceType) {
        ...
        this.camera.getPicture(options).then(function (imagePath) {
            ...
            _this.presentToast('Ocorreu um erro enquando selecionava a imagem');
        });
    };
    ...
    HomePage.prototype.copyFileToLocalDir = function (namePath, currentName, newFileName) {
        ...
        this.file.copyFile(namePath, currentName, cordova.file.dataDirectory, newFileName)
            ...
            _this.presentToast('Erro enquanto armazenava o arquivo.');
        });
    };
    ...
    HomePage.prototype.uploadImage = function () {
        ...
        fileTransfer.upload(targetPath, url, options).then(function (data) {
            ...
            _this.presentToast('Imagem Carregada com sucesso.');
        }, function (err) {
            _this.loading.dismissAll();
            _this.presentToast('Erro enquanto carregava a imagem ');
        });
    };
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__pages_gps_gps__ = __webpack_require__(199);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__ionic_native_transfer__ = __webpack_require__(196);
